...
- [3. 文件类型相关](#3-文件类型相关)
  ...
  - [3.8. .dep 文件（Dependency File）](#38-dep-文件dependency-file)
  - [3.9. .crf 文件（Cross-Reference File）](#39-crf-文件cross-reference-file)
  - [3.10. .d 文件（Dependency File）](#310-d-文件dependency-file)
  - [3.11. .o 文件（Object File）](#311-o-文件object-file)
  - [3.12. .build\_log.htm 文件（Build Log HTML File）](#312-build_loghtm-文件build-log-html-file)
  - [3.13. .htm 文件（HTML Report File）](#313-htm-文件html-report-file)
  - [3.14. .lnp 文件（Linker Settings）](#314-lnp-文件linker-settings)
