...
- [17. APB（Advanced Peripheral Bus）](#17-apbadvanced-peripheral-bus)
- [18. RCC（Reset and Clock Control）](#18-rccreset-and-clock-control)
- [19. SDIO（Secure Digital Input Output）](#19-sdiosecure-digital-input-output)
- [20. 桥接器（Bridges）](#20-桥接器bridges)
- [21. CRC（Cyclic Redundancy Check）](#21-crccyclic-redundancy-check)
- [22. GPIO（General-Purpose Input/Output）](#22-gpiogeneral-purpose-inputoutput)
- [23. GPIOx\_ODR（Output Data Register）](#23-gpiox_odroutput-data-register)
- [24. GPIOx\_IDR（Input Data Register）](#24-gpiox_idrinput-data-register)
- [25. GPIOx\_CRL（Configuration Register Low）](#25-gpiox_crlconfiguration-register-low)
- [26. GPIOx\_CRH（Configuration Register High）](#26-gpiox_crhconfiguration-register-high)
- [27. GPIOx\_BSRR（Bit Set/Reset Register）](#27-gpiox_bsrrbit-setreset-register)
- [28. GPIOx\_BRR（Bit Reset Register）](#28-gpiox_brrbit-reset-register)
- [29. GPIOx\_LCKR（Lock Register）](#29-gpiox_lckrlock-register)
- [30. HSI（High-Speed Internal）](#30-hsihigh-speed-internal)
- [31. 推挽输出（Push-Pull）](#31-推挽输出push-pull)
- [32. 开漏输出（Open-Drain）](#32-开漏输出open-drain)
- [33. .sct 文件](#33-sct-文件)
- [34. .uvprojx 文件](#34-uvprojx-文件)
- [35. .uvoptx 文件](#35-uvoptx-文件)
- [36. .uvguix. 文件](#36-uvguix-文件)
...
### 11. 内部 SRAM（Static Random Access Memory）
...
### 12. CMSIS-DAP（Cortex Microcontroller Software Interface Standard - Debug Access Port）
...
### 16. AHB（Advanced High-performance Bus）
...
### 17. APB（Advanced Peripheral Bus）
...
### 18. RCC（Reset and Clock Control）
...
### 19. SDIO（Secure Digital Input Output）
...
### 25. GPIOx_CRL（Configuration Register Low）
> CRL 是 "Configuration Register Low" 的缩写。
> CRL负责配置低8个引脚（PIN0到PIN7）

### 26. GPIOx_CRH（Configuration Register High）
