...
- [1. 嵌入式开发词汇表](#1-嵌入式开发词汇表)
  - [1.1. 嵌入式基础知识相关](#11-嵌入式基础知识相关)
    - [1.1.1. 数据手册（Data Sheet）](#111-数据手册data-sheet)
    - [1.1.2. 参考手册（Reference Manual）](#112-参考手册reference-manual)
    - [1.1.3. ISP（In-System Programming）](#113-ispin-system-programming)
    - [1.1.4. NRST（Negative Reset）](#114-nrstnegative-reset)
    - [1.1.5. RST（Reset）](#115-rstreset)
    - [1.1.6. RTS（Request to Send）](#116-rtsrequest-to-send)
    - [1.1.7. DTR（Data Terminal Ready）](#117-dtrdata-terminal-ready)
    - [1.1.8. SWD（Serial Wire Debug）](#118-swdserial-wire-debug)
    - [1.1.9. 内部 FLASH](#119-内部-flash)
  ...
  - [1.2. 寄存器相关](#12-寄存器相关)
    ...
    - [1.2.3. DMA（Direct Memory Access）](#123-dmadirect-memory-access)
    - [1.2.4. AHB（Advanced High-performance Bus）](#124-ahbadvanced-high-performance-bus)
    - [1.2.5. APB（Advanced Peripheral Bus）](#125-apbadvanced-peripheral-bus)
    - [1.2.6. RCC（Reset and Clock Control）](#126-rccreset-and-clock-control)
    - [1.2.7. SDIO（Secure Digital Input Output）](#127-sdiosecure-digital-input-output)
    - [1.2.8. 桥接器（Bridges）](#128-桥接器bridges)
    - [1.2.9. CRC（Cyclic Redundancy Check）](#129-crccyclic-redundancy-check)
    - [1.2.10. GPIO（General-Purpose Input/Output）](#1210-gpiogeneral-purpose-inputoutput)
    - [1.2.11. GPIOx\_ODR（Output Data Register）](#1211-gpiox_odroutput-data-register)
    - [1.2.12. GPIOx\_IDR（Input Data Register）](#1212-gpiox_idrinput-data-register)
    - [1.2.13. GPIOx\_CRL（Configuration Register Low）](#1213-gpiox_crlconfiguration-register-low)
    - [1.2.14. GPIOx\_CRH（Configuration Register High）](#1214-gpiox_crhconfiguration-register-high)
    - [1.2.15. GPIOx\_BSRR（Bit Set/Reset Register）](#1215-gpiox_bsrrbit-setreset-register)
    - [1.2.16. GPIOx\_BRR（Bit Reset Register）](#1216-gpiox_brrbit-reset-register)
    - [1.2.17. GPIOx\_LCKR（Lock Register）](#1217-gpiox_lckrlock-register)
    - [1.2.18. HSI（High-Speed Internal）](#1218-hsihigh-speed-internal)
    - [1.2.19. 推挽输出（Push-Pull）](#1219-推挽输出push-pull)
    - [1.2.20. 开漏输出（Open-Drain）](#1220-开漏输出open-drain)
  - [1.3. 文件类型相关](#13-文件类型相关)
    - [1.3.1. .sct 文件](#131-sct-文件)
    - [1.3.2. .uvprojx 文件](#132-uvprojx-文件)
    - [1.3.3. .uvoptx 文件](#133-uvoptx-文件)
    - [1.3.4. .uvguix. 文件](#134-uvguix-文件)
    - [1.3.5. .dbgconf 文件](#135-dbgconf-文件)
    - [1.3.6. .lst 文件（Listing 文件）](#136-lst-文件listing-文件)
    - [1.3.7. .map 文件（Map 文件）](#137-map-文件map-文件)
    - [1.3.8. .dep 文件（Dependency File）](#138-dep-文件dependency-file)
    - [1.3.9. .crf 文件（Cross-Reference File）](#139-crf-文件cross-reference-file)
    - [1.3.10. .d 文件（Dependency File）](#1310-d-文件dependency-file)
    - [1.3.11. .o 文件（Object File）](#1311-o-文件object-file)
    - [1.3.12. .build\_log.htm 文件（Build Log HTML File）](#1312-build_loghtm-文件build-log-html-file)
    - [1.3.13. .htm 文件（HTML Report File）](#1313-htm-文件html-report-file)
    - [1.3.14. .lnp 文件（Linker Settings）](#1314-lnp-文件linker-settings)

## 1.1. 嵌入式基础知识相关

### 1.1.1. 数据手册（Data Sheet）
...
### 1.1.3. ISP（In-System Programming）
...
### 1.1.11. 内部 SRAM（Static Random Access Memory）
...
### 1.1.12. CMSIS-DAP（Cortex Microcontroller Software Interface Standard - Debug Access Port）
...
### 1.2.2. FSMC（Flexible static memory controller）
...
### 1.2.3. DMA（Direct Memory Access）
...
### 1.2.4. AHB（Advanced High-performance Bus）
...
### 1.2.5. APB（Advanced Peripheral Bus）
...
### 1.2.6. RCC（Reset and Clock Control）
...
### 1.2.7. SDIO（Secure Digital Input Output）
...
### 1.2.9. CRC（Cyclic Redundancy Check）
...
### 1.2.10. GPIO（General-Purpose Input/Output）
...
### 1.2.16. GPIOx_BRR（Bit Reset Register）
