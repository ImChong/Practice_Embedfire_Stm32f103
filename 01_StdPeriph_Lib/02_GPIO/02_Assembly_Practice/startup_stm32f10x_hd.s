...
/* ==================================================================================================== */
/* DONE: 3 - Vector Table 向量表*/
/* NOTE: 初始化中断向量表 */
/* NOTE: 在向量表中，DCD 分配了一堆内存，并且以 ESR 的入口地址初始化它们 */
/* BUG: ！！函数名一定要和中断向量表内的名称一致！！，否则启动文件找不到对应的中断函数 */
/* ==================================================================================================== */
...
/* ==================================================================================================== */
/* DONE: 4 - Reset handler 复位程序 */
/* NOTE: LDR、BLX、BX 是CM4 内核的指令 */
/* LDR: 加载 - 从存储器中加载字到一个寄存器中 */
...
/* ==================================================================================================== */
/* DONE: 5 - Exception Handlers 中断服务函数 */
